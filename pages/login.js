    ...
    <Layout>
        <form onSubmit={handleSubmit} style={{textAlign: "center"}} >
          ...
          <div className="form-floating">
            <input type="username" className="form-control" id="username" placeholder="Username" onChange={e => setError("")}/>
            <label htmlFor="floatingInput">Username</label>
          </div>
          <div className="form-floating" >
            <input id="password" className="form-control" type="password" placeholder="Password" onChange={e => setError("")}/>
